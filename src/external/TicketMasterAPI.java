...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "PVkXAv6VkuXrHOzNOJbzKZETA4PmOsyl";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		// "http://app.ticket.master.com/discovery/v2/events.json?apikey=12345&geoPoint=abcd&keyword=music&radius=50"
	...
	public static void main(String[] args) {
		...
		// Mountain View, CA
	              tmApi.queryAPI(33.6694612565,-117.8283905983);
	}
